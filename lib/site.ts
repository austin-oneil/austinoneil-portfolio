...
export const site = {
  name: "Austin O'Neil",
  role: "Full-stack developer and technical SEO specialist",
  ...
  description:
    "Austin O'Neil is a full-stack developer and technical SEO specialist in Denver who spent twelve years in hospitality and sales first. He builds production software and runs technical SEO across a 100-plus client agency book. Case studies in AWS, WordPress plugin engineering, serverless AI and Next.js.",
